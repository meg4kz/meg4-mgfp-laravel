...
#[IsReadOnly(true)]
#[Description('Lista pedidos. Filtros típicos: estado (pendiente/pagado/enviado), fecha.')]
class ListOrdersTool extends MgfpTool
{
    ...
    {
        return [
            'filter' => $schema->string()->description('Filtro de texto/estado (opcional).'),
    ...
    public function handle(Request $request): Response
    {
        ...
        return Response::structured($this->store->listOrders(

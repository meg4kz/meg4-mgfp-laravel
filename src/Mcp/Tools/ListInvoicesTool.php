...
#[IsReadOnly(true)]
#[Description('Lista facturas emitidas. Filtros: estado, cliente, rango de fechas.')]
class ListInvoicesTool extends MgfpTool
{
    ...
    public function handle(Request $request): Response
    {
        ...
        return Response::structured($this->store->listInvoices(
